  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className="main_container">
        ...
        <nav className="w-full min-h-9 mb-2 fixed bottom-0 left-0 flex items-center justify-center">
          <div className="flex gap-1 items-center select-none rounded-[12px] md:shadow-md max-h-9 bg-[#222222]">
